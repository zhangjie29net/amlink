...
namespace Esim7.UNity
{
    public class SendEmail
    {
        ...
        public static void SendMail(string FromMial, string ToMial, string AuthorizationCode, string ReplyTo, string CCMial, string File_Path, string Subject, string MailBody)
        {
            try
            {
                //实例化一个发送邮件类。
               ...
               //LogHelper.Log("邮件发送成功");
            }
            catch (Exception ex)
            {
                //LogHelper.Log("邮件发送失败" + ex.Message);
